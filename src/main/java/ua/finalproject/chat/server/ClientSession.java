...
/**
 * Одна TCP-сесія клієнта.
 * Сесія читає пакети із сокета, передає їх на обробку та відправляє відповідь назад клієнту.
 */
public final class ClientSession implements Runnable {
    ...
    @Override
    /**
     * Основний цикл сесії: читає пакети до закриття сокета або помилки.
     */
    public void run() {
        try {
    ...
    /**
     * Декодує пакет, виконує команду і за потреби реєструє авторизованого користувача в реєстрі онлайн-сесій.
     */
