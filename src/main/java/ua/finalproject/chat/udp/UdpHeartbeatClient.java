...
/**
 * UDP-клієнт для перевірки доступності сервера.
 * Надсилає короткий ping і чекає відповідь pong протягом заданого часу.
 */
public final class UdpHeartbeatClient {
    ...
    /**
     * Надсилає ping кілька разів, поки не отримає pong або поки не вичерпає спроби.
     */
