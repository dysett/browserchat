...
/**
 * Кодує ChatMessage у байти та відновлює його назад.
 * Формат містить команду, номер запиту та набір текстових полів.
 */
public final class MessageCodec {
    ...
    /**
     * Кодує команду, requestId і поля повідомлення у внутрішній байтовий формат.
     */
    ...
    /**
     * Розбирає байтовий формат і створює ChatMessage.
     */
