...
/**
 * Шифрування і розшифрування тіла TCP-пакета за допомогою AES.
 * Один спільний секрет використовується для створення ключа та однакового кодування повідомлень на клієнті й сервері.
 */
