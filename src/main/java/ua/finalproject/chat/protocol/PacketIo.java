...
/**
 * Допоміжний клас для читання та запису пакетів у потоках сокета.
 * Перед кожним пакетом передається його довжина, щоб приймач знав, скільки байтів треба прочитати.
 */
